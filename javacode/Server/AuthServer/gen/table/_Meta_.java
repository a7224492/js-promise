...
final class _Meta_ {
	...
	public static Zdb create() {
		...
		Cbean cAccountTableKey = new Cbean(_meta_, "AccountTableKey");
		new Variable.Builder(cAccountTableKey,"accountString", "string");
		new Variable.Builder(cAccountTableKey,"appId", "int");
		...
		Xbean xWhiteList = new Xbean(_meta_, "WhiteList");
		new Variable.Builder(xWhiteList,"list", "vector").value("int");
		...
		new Table.Builder(_meta_, "account_table_new", "AccountTableKey", "AccountInfo");
		new Table.Builder(_meta_, "test", "int", "int");
		...
		new Table.Builder(_meta_, "account_white_list", "int", "WhiteList");
