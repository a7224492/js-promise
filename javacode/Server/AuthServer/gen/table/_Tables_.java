...
final class _Tables_ {
	...
	class Account_table_new extends limax.zdb.TTable<cbean.AccountTableKey, xbean.AccountInfo> {
		@Override
		public String getName() {
			return "account_table_new";
		}

		@Override
		protected OctetsStream marshalKey(cbean.AccountTableKey key) {
		...
		@Override
		protected cbean.AccountTableKey unmarshalKey(OctetsStream _os_) throws MarshalException {
			cbean.AccountTableKey key = new cbean.AccountTableKey();
			key.unmarshal(_os_);
			return key;
		}
		...
		xbean.AccountInfo insert(cbean.AccountTableKey key) {
			xbean.AccountInfo value = new xbean.AccountInfo();
			return add(key, value) ? value : null;
		}

		xbean.AccountInfo update(cbean.AccountTableKey key) {
			return get(key, true);
		}

		xbean.AccountInfo select(cbean.AccountTableKey key) {
			return get(key, false);
		}

		boolean delete(cbean.AccountTableKey key) {
			return remove(key);
		}

	};

	Account_table_new account_table_new = new Account_table_new();

	class Test extends limax.zdb.TTable<Integer, Integer> {
		@Override
		public String getName() {
			return "test";
		}
	...
	class Account_white_list extends limax.zdb.TTable<Integer, xbean.WhiteList> {
		@Override
		public String getName() {
		...
		@Override
		protected OctetsStream marshalValue(xbean.WhiteList value) {
			OctetsStream _os_ = new OctetsStream();
			_os_.marshal(value);
			return _os_;
		}
		...
		@Override
		protected xbean.WhiteList unmarshalValue(OctetsStream _os_) throws MarshalException {
			xbean.WhiteList value = new xbean.WhiteList();
			value.unmarshal(_os_);
			return value;
		}

		@Override
		protected xbean.WhiteList newValue() {
			xbean.WhiteList value = new xbean.WhiteList();
			return value;
		}

		xbean.WhiteList insert(Integer key) {
			xbean.WhiteList value = new xbean.WhiteList();
			return add(key, value) ? value : null;
		}

		xbean.WhiteList update(Integer key) {
			return get(key, true);
		}

		xbean.WhiteList select(Integer key) {
			return get(key, false);
		}
	...
	Account_white_list account_white_list = new Account_white_list();
