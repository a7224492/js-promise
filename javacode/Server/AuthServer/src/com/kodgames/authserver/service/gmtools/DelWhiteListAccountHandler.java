 ...
 * 删除白名单账号
 */
@GmtHandlerAnnotation(handler = "DelWhiteListAccountHandler")
public class DelWhiteListAccountHandler implements IGmtoolsHandler {
    private static final Logger logger = LoggerFactory.getLogger(DelWhiteListAccountHandler.class);
    ...
    public HashMap<String, Object> getResult(Map<String, Object> args) {
        ...
        boolean ret = service.removeAccount(id);
