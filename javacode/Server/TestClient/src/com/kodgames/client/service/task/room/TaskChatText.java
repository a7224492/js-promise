 ...
 * 常用语聊天
 */
public class TaskChatText implements Task {
    private static Logger logger = LoggerFactory.getLogger(TaskChatText.class);

    @Override
    public void process(Role role, Room room) {
        logger.info("text chat task for room {}", room.getId());
