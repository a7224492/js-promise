 ...
 */
public class TaskChatCustom implements Task {
    private static Logger logger = LoggerFactory.getLogger(TaskChatCustom.class);

    @Override
    public void process(Role role, Room room) {
        logger.info("custom chat task for room {}", room.getId());
