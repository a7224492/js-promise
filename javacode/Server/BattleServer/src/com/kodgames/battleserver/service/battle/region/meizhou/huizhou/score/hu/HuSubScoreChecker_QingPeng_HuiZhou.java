 ...
 * 惠州清碰：清一色+碰碰胡。
 */
public class HuSubScoreChecker_QingPeng_HuiZhou extends HuSubScoreChecker
{
	public HuSubScoreChecker_QingPeng_HuiZhou()
	{
		super(PlayType.HU_QING_PENG_HUI_ZHOU);
	}
