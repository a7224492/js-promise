package com.kodgames.battleserver.service.battle.region.neimeng.bayannaoer;
 ...
 * 内蒙：巴彦淖尔
 */
public class BattleCreator_NeiMeng_BaYanNaoEr implements IBattleCreator
{
	@Override
	...
	{
		return Rules_NeiMeng.checkRules(rules, Rules_NeiMeng.GAME_TYPE_BAYANNAOER);
	}
	...
	private void createHuCalculateProcessor(JSONObject context, List<Integer> rules)
	{
		...
		// 支持的分数
		{
			...
			if (rules.contains(Rules_NeiMeng.SHI_SAN_YAO))
