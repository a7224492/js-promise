 ...
 * 马跟杠杠分翻倍
 */
public class Processor_JiangMa_HeYuan extends Processer
{
	/**
	 * 玩家对应的奖马信息数组
	 */
	...
	public static final String KEY_MA_GEN_FAN = "maGenFan";
	public static final String KEY_YING_MA = "yingMa";

	/** 马跟翻 */
	protected boolean maGenFan;

	/** 硬马 */
	protected boolean yingMa;
	...
	public void createFromContext(JSONObject context)
		throws Exception
	{
		maGenFan = CreateContextParser.getBoolean(context, KEY_MA_GEN_FAN);
		yingMa = CreateContextParser.getBoolean(context, KEY_YING_MA);
	...
	private void bettingHorse()
	{
		...
		context.getHuIndex().forEach(huIndex -> {
			...
			else if (yingMa)
			{
				...
				point.setScoreValue(bettingCards.size() * 3);
			}
