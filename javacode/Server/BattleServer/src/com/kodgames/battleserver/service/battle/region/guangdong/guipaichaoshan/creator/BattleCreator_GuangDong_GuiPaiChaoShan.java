package com.kodgames.battleserver.service.battle.region.guangdong.guipaichaoshan.creator;
 ...
 * 潮汕规则的creator
 */
public class BattleCreator_GuangDong_GuiPaiChaoShan implements IBattleCreator
{
	...
	{
		return Rules_GuangDong.checkRules(rules, Rules_GuangDong.GAME_TYPE_GUI_CHAO_SHAN);
	}
