 ...
 * 检测牌形:杠上炮之呼叫转移
 */
public class HuSubScoreChecker_HuJiaoZhuanYi extends HuSubScoreChecker
{
	public HuSubScoreChecker_HuJiaoZhuanYi()
	{
		super(PlayType.DISPLAY_HU_JIAO_ZHUAN_YI);
	}
