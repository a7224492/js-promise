package com.kodgames.battleserver.service.battle.region.meizhou.common.score.game;
...
public class GameScoreCalculator_MeiZhou extends GameScoreCalculator
{
	public static final String KEY_GAME_SCORE_FILTERS_MEIZHOU = "gameScoreFilter_MEIZHOU";
	...
	{
		// 解析参数
		for (JSONObject subContext : CreateContextParser.getJSONArray(context, KEY_GAME_SCORE_FILTERS_MEIZHOU))
