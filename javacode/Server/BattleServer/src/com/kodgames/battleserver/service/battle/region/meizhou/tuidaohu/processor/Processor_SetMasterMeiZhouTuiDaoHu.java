...
public class Processor_SetMasterMeiZhouTuiDaoHu  extends Processer
{
	...
	private void checkMasterCard()
	{
		...
		{
			context.addCardHeap(player.getRoleId(), PlayType.DISPLAY_SHOW_MASTER_CARD, generatedMasterCards);
			context.setPlayerMasterCard(player.getRoleId(), generatedMasterCards);
			
			// 发送鬼牌
			Step op = new Step(player.getRoleId(), MahjongConstant.PlayType.DISPLAY_SHOW_MASTER_CARD, generatedMasterCards);
