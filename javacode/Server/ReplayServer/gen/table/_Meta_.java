...
final class _Meta_ {
	...
	public static Zdb create() {
		...
		new Variable.Builder(xRoomHistory,"creatorId", "int");
		new Variable.Builder(xRoomHistory,"payType", "int");
		...
		new Table.Builder(_meta_, "role_history_rooms", "int", "RoleInfo").cacheCap("5000");
		new Table.Builder(_meta_, "room_history", "GlobalRoomId", "RoomHistory").cacheCap("5000");
