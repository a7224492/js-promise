...
public final class RoomHistory extends limax.zdb.XBean {
	...
	public void copyFrom(RoomHistory _o_) {
        ...
        this.enableMutilHu = _o_.enableMutilHu;
        limax.zdb.Logs.logObject(this, "creatorId");
        this.creatorId = _o_.creatorId;
	...
	public final OctetsStream unmarshal(OctetsStream _os_) throws MarshalException {
		...
		this.creatorId = _os_.unmarshal_int();
	...
	public int getCreatorId() { 
		this.verifyStandaloneOrLockHeld("getCreatorId", true);
	...
	public void setCreatorId(int _v_) { 
		this.verifyStandaloneOrLockHeld("setCreatorId", false);
		limax.zdb.Logs.logObject(this, "creatorId");
		this.creatorId = _v_;
	}
	...
	public final boolean equals(Object _o1_) {
		...
		if (this.creatorId != _o_.creatorId) return false;
