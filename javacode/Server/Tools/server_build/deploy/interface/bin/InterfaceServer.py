...
log_file_name="InterfaceServer"
java_param_main_class="com.kodgames.interfaces.InterfaceServer"
java_param_server_name_id="InterfaceServer"
java_param_server_mem="-Xmx2048m -Xms1024m -Xss256k -Duser.timezone=GMT+08"

group_type="interface"
area_id="1"
